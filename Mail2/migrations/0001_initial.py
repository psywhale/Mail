    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fk_to', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='attachment',
            name='fk_mail',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Mail2.Mail'),
        ),
    ]
