"""
Django settings for Mail2proj project.
...
salty = random.randint(40000, 2001010)
key = hashlib.sha512(str(random.getrandbits(256)).encode('utf-8')).hexdigest()
...
ALLOWED_HOSTS = ['brian-ms-7a70','127.0.0.1','mail2.wosc.edu', 'localhost', '172.22.8.126']
...
MEDIAFILES_DIRS = ("/media/", BASE_DIR + "/media/")
MEDIA_URL = '/media/'
...
MAIL_SERVER='10.250.20.169'
LTI_LOGIN_URL='https://moodle.wosc.edu/mod/lti/view.php?id=26984'
SERVER_URL='https://mail2.wosc.edu'
MOODLE_URL='https://moodle.wosc.edu/'
